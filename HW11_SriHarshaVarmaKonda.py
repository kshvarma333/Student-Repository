...
class University:
    def __init__(self, path: str) -> None:
        ...
        self.student_grade_list_db: List = []
        ...
        self.pt_student_grades: PrettyTable = PrettyTable(
    ...
    def student_grades_table_db(self, db_path: str) -> None:
        ...
        for row in db.execute("select s.Name, s.CWID, g.Course, g.Grade, i.Name from  students as s join grades as g on s.CWID = g.StudentCWID join instructors as i on i.CWID = g.InstructorCWID order by s.Name"):
            """ printing pretty table """
            self.pt_student_grades.add_row(
                [row[0], row[1], row[2], row[3], row[4]])
            self.student_grade_list_db.append(row)
        return self.pt_student_grades
...
# print(uni.major())
# print(uni.student_grades_table_db("/Users/harru/PYTHON(SSW 810 )/HW11.db"))
